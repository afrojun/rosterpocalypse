...
ActiveRecord::Schema.define(version: 20170726131637) do
  ...
  create_table 'game_details', id: :serial, force: :cascade do |t|
    ...
    t.index ['hero_id'], name: 'index_game_details_on_hero_id'
  ...
  create_table 'games', id: :serial, force: :cascade do |t|
    ...
    t.index ['gameweek_id'], name: 'index_games_on_gameweek_id'
  ...
  create_table 'gameweek_players', id: :serial, force: :cascade do |t|
    ...
    t.index ['gameweek_id', 'player_id'], name: 'index_gameweek_players_on_gameweek_id_and_player_id'
    t.index ['gameweek_id'], name: 'index_gameweek_players_on_gameweek_id'
    t.index ['player_id', 'gameweek_id'], name: 'index_gameweek_players_on_player_id_and_gameweek_id'
    t.index ['player_id'], name: 'index_gameweek_players_on_player_id'
    t.index ['points'], name: 'index_gameweek_players_on_points'
  end
  ...
  create_table 'gameweek_rosters', id: :serial, force: :cascade do |t|
    t.integer 'gameweek_id', null: false
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['gameweek_id', 'roster_id'], name: 'index_gameweek_rosters_on_gameweek_id_and_roster_id'
    t.index ['gameweek_id'], name: 'index_gameweek_rosters_on_gameweek_id'
    t.index ['points'], name: 'index_gameweek_rosters_on_points'
    t.index ['roster_id', 'gameweek_id'], name: 'index_gameweek_rosters_on_roster_id_and_gameweek_id'
    t.index ['roster_id'], name: 'index_gameweek_rosters_on_roster_id'
  end

  create_table 'gameweek_statistics', id: :serial, force: :cascade do |t|
    t.integer 'gameweek_id', null: false
    t.text 'dream_team'
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['gameweek_id'], name: 'index_gameweek_statistics_on_gameweek_id', unique: true
  end

  create_table 'gameweeks', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['end_date'], name: 'index_gameweeks_on_end_date'
    t.index ['roster_lock_date'], name: 'index_gameweeks_on_roster_lock_date'
    t.index ['start_date'], name: 'index_gameweeks_on_start_date'
    t.index ['tournament_id'], name: 'index_gameweeks_on_tournament_id'
  end

  create_table 'heroes', id: :serial, force: :cascade do |t|
    t.string 'name', null: false
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['internal_name'], name: 'index_heroes_on_internal_name', unique: true
  ...
  create_table 'league_gameweek_players', id: :serial, force: :cascade do |t|
    ...
    t.index ['gameweek_player_id'], name: 'index_league_gameweek_players_on_gameweek_player_id'
    t.index ['league_id', 'gameweek_player_id'], name: 'idx_league_gameweek_players_on_league_id_and_gameweek_player_id'
    t.index ['league_id'], name: 'index_league_gameweek_players_on_league_id'
  end
  ...
  create_table 'leagues', id: :serial, force: :cascade do |t|
    ...
    t.index ['featured'], name: 'index_leagues_on_featured'
    t.index ['manager_id'], name: 'index_leagues_on_manager_id'
    t.index ['name'], name: 'index_leagues_on_name', unique: true
    t.index ['premium'], name: 'index_leagues_on_premium'
    t.index ['slug'], name: 'index_leagues_on_slug', unique: true
    t.index ['tournament_id'], name: 'index_leagues_on_tournament_id'
    t.index ['type'], name: 'index_leagues_on_type'
  end

  create_table 'leagues_rosters', id: false, force: :cascade do |t|
    t.integer 'league_id', null: false
    t.integer 'roster_id', null: false
    t.index ['league_id', 'roster_id'], name: 'index_leagues_rosters_on_league_id_and_roster_id'
    t.index ['roster_id', 'league_id'], name: 'index_leagues_rosters_on_roster_id_and_league_id'
  end
  ...
  create_table 'managers', id: :serial, force: :cascade do |t|
    ...
    t.index ['stripe_customer_id'], name: 'index_managers_on_stripe_customer_id', unique: true
  ...
  create_table 'matches', id: :serial, force: :cascade do |t|
    ...
    t.index ['start_date'], name: 'index_matches_on_start_date'
    t.index ['team_1_id'], name: 'index_matches_on_team_1_id'
    t.index ['team_2_id'], name: 'index_matches_on_team_2_id'
  end

  create_table 'player_alternate_names', id: :serial, force: :cascade do |t|
    t.integer 'player_id'
    t.string 'alternate_name', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['alternate_name'], name: 'index_player_alternate_names_on_alternate_name', unique: true
    t.index ['player_id'], name: 'index_player_alternate_names_on_player_id'
  end
  ...
  create_table 'rosters', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.float 'budget', default: 500.0, null: false
    t.index ['manager_id'], name: 'index_rosters_on_manager_id'
    t.index ['name'], name: 'index_rosters_on_name', unique: true
    t.index ['score'], name: 'index_rosters_on_score'
  ...
  create_table 'team_alternate_names', id: :serial, force: :cascade do |t|
    t.integer 'team_id'
    t.string 'alternate_name', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['alternate_name'], name: 'index_team_alternate_names_on_alternate_name', unique: true
    t.index ['team_id'], name: 'index_team_alternate_names_on_team_id'
  end
  ...
  create_table 'transfers', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['gameweek_roster_id'], name: 'index_transfers_on_gameweek_roster_id'
